			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '';
						...
						// 	echo   
						// 		'<input type="hidden" name="return" value="http://localhost/viewpointoptical/payment_success.php"/>
					    //             <input type="hidden" name="notify_url" value="http://localhost/viewpointoptical/payment_success.php">
						// 			<input type="hidden" name="cancel_return" value="http:/viewpointoptical/localhost//cancel.php"/>
